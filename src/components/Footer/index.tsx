...
import {Wrapper, Container, Column1, Column2, Column3, Column4, Column5, Column6, Input, InputText, Link1, Link2, Logos, Visas} from "./footer.style.js";
import {Text1, Text2, Text3, Text4, Text5, Text6, Text7, Text8, Text9, Text10, Row1} from "./footer.style.js";
